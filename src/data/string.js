module.exports = [
  {
    ...
    question: `Ikkita satr berilgan, a va b, ularni abba tartibida birlashtirish natijasini qaytaring, masalan: "Hi" va "Bye" "HiByeByeHi"ni qaytaradi.`,
  }, {
    title: 'String-1',
    name: 'makeTags',
    question: `Veb "<i>Yay</i>" kabi HTML satrlari bilan qurilgan bo'lib, Yay kursiv matn sifatida chiziladi. Ushbu misolda "i" tegi "Yay" so'zini o'rab turgan <i> va </i> ni hosil qiladi. Teg va soʻz qatorlari berilgan boʻlsa, soʻz atrofida teglar bilan HTML qatorini qaytaring, masalan: "<i>Hay</i>".`,
    inputs: [
      "('i', 'Yay')",
      "('i', 'Hello')",
      "('cite', 'Yay')",
    ...
    question: `"<<>>" kabi "out" satr uzunligi 4, va so'z berilgan bo'lsa, so'z chiqish qatorining o'rtasida joylashgan yangi qatorni qaytaring, masalan. "<<word>>". Eslatma: str.substring(i, j) dan i indeksidan boshlanib, j indeksini o'z ichiga olmasdan yuqoriga ko'tariladigan Stringni chiqarish uchun foydalaning.`,
  }, {
    title: 'String-1',
    name: 'extraEnd',
    inputs: [
    ...
    question: `2 ta qator berilgan, a va b, qisqa + uzun + qisqa ko‘rinishdagi satrni qaytaring, qisqaroq satr tashqi tomonda, uzunroq satr esa ichki tomonda joylashishi kerak. Satrlar bir xil uzunlikda bo'lmaydi, lekin ular bo'sh bo'lishi mumkin (length = 0).`,
  }, {
    title: 'String-1',
    name: 'nonStart',
    inputs: [
    ...
    question: `2 ta satr berilgan, ularning birlashmasini qaytaring, har birining birinchi belgisini hisobga olmang. Satrlar uzunligi kamida 1 ta belgidan iborat bo'ladi.`,
  }, {
    title: 'String-1',
    name: 'left2',
    inputs: [
    ...
    question: `Satr berilgan, birinchi 2 ta belgi oxiriga ko'chirilgan holatdagi yangi satrni qaytaring. Satr uzunligi kamida 2 ta belgidan iborat bo'ladi.`,
  }, {
    title: 'String-1',
    name: 'right2',
    inputs: [
